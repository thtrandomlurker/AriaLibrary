...
{
    public partial class MRWMaterialSetupControl : UserControl
    {
        new public ModelReplaceWizard Parent;

        public MRWMaterialSetupControl(Form parent)
        {
            InitializeComponent();
            Parent = (ModelReplaceWizard)parent;
        ...
        private void MIWMaterialSelectShader_Click(object sender, EventArgs e)
        {
            ...
            {
                using (MRWShaderSelector shaderSelector = new MRWShaderSelector(MIWMaterialOpenShaderDialog.FileName, this.Parent, this))
                {
        ...
        private void MIWMaterialSelectShaderAll_Click(object sender, EventArgs e)
        {
            if (MIWMaterialOpenShaderDialog.ShowDialog() == DialogResult.OK)
            {
                using (MRWShaderSelector shaderSelector = new MRWShaderSelector(MIWMaterialOpenShaderDialog.FileName, this.Parent, this, true))
                {
                    shaderSelector.ShowDialog();
                }
            }
